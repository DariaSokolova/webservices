...
public class Theatre extends AbstractBean {
	...
	private Set<TheatreOwner> theatreOwners;	
	...
	public Set<TheatreOwner> getTheatreOwners() {
		return theatreOwners;
	}

	public void setTheatreOwners(Set<TheatreOwner> theatreOwners) {
		this.theatreOwners = theatreOwners;
	}
